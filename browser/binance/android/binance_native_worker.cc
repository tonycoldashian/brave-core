...
void BinanceNativeWorker::GetAccessToken(JNIEnv* env) {
  if (binance_service_) {
    binance_service_->GetAccessToken(base::BindRepeating(
...
void BinanceNativeWorker::GetAccountBalances(JNIEnv* env) {
  if (binance_service_) {
    binance_service_->GetAccountBalances(
        base::BindRepeating(&BinanceNativeWorker::OnGetAccountBalances,
...
void BinanceNativeWorker::GetConvertQuote(
  ...
  if (binance_service_) {
    binance_service_->GetConvertQuote(
        ...
        base::BindRepeating(&BinanceNativeWorker::OnGetConvertQuote,
                            weak_factory_.GetWeakPtr()));
  }
}
...
void BinanceNativeWorker::GetCoinNetworks(JNIEnv* env) {
  if (binance_service_) {
    binance_service_->GetCoinNetworks(base::BindRepeating(
...
void BinanceNativeWorker::GetDepositInfo(
  ...
  if (binance_service_) {
    binance_service_->GetDepositInfo(
        ...
        base::BindRepeating(&BinanceNativeWorker::OnGetDepositInfo,
                            weak_factory_.GetWeakPtr()));
  }
}
...
void BinanceNativeWorker::ConfirmConvert(
  ...
  if (binance_service_) {
    binance_service_->ConfirmConvert(
        ...
        base::BindRepeating(&BinanceNativeWorker::OnConfirmConvert,
                            weak_factory_.GetWeakPtr()));
  }
}
...
void BinanceNativeWorker::GetConvertAssets(JNIEnv* env) {
  if (binance_service_) {
    binance_service_->GetConvertAssets(base::BindRepeating(
...
void BinanceNativeWorker::RevokeToken(JNIEnv* env) {
  if (binance_service_) {
    binance_service_->RevokeToken(base::BindRepeating(
